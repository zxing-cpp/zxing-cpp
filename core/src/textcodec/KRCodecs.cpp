...
static const uint16_t cp949_icode_to_unicode[] =
{
...
static const uint16_t ksc5601_hangul_to_unicode[2350] =
{
...
void
KRCodecs::AppendEucKr(std::vector<uint16_t>& result, const uint8_t* bytes, size_t length)
{
	uint8_t buf[2] = { 0, 0 };
	int nbuf = 0;
	int invalid = 0;
