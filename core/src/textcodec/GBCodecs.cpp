...
void
GBCodecs::AppendGB18030(std::vector<uint16_t>& result, const uint8_t* bytes, size_t length)
{
	uint8_t buf[4];
	int nbuf = 0;
	int invalid = 0;
...
void
GBCodecs::AppendGB2312(std::vector<uint16_t>& result, const uint8_t* bytes, size_t length)
{
	uint8_t buf[2];
	int nbuf = 0;
	int invalid = 0;
