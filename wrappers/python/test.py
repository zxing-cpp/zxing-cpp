...
class TestReadWrite(unittest.TestCase):
    ...
    def test_failed_read(self):
        ...
        res = zxingcpp.read_barcode(
            np.zeros((100, 100), np.uint8), formats=BF.EAN8 | BF.Aztec,
    ...
    def test_read_invalid_type(self):
        self.assertRaisesRegex(
            TypeError,
            'Unsupported type <class \'str\'>. Expect a PIL Image or numpy array',
    ...
    def test_read_invalid_numpy_array_channels(self):
        ...
        self.assertRaisesRegex(
            TypeError,
            'Unsupported number of channels for numpy array: 4',
            zxingcpp.read_barcode,
